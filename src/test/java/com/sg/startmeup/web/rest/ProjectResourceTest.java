...
public class ProjectResourceTest {
    ...
    private static final LocalDate DEFAULT_MYDATE = new LocalDate(0L);
    private static final LocalDate UPDATED_MYDATE = new LocalDate();
    ...
    public void initTest() {
        ...
        project.setMydate(DEFAULT_MYDATE);
    }
    ...
    public void createProject() throws Exception {
        ...
        assertThat(testProject.getMydate()).isEqualTo(DEFAULT_MYDATE);
    }
    ...
    public void getAllProjects() throws Exception {
        ...
        restProjectMockMvc.perform(get("/api/projects"))
                ...
                .andExpect(jsonPath("$.[*].mydate").value(hasItem(DEFAULT_MYDATE.toString())));
    }
    ...
    public void getProject() throws Exception {
        ...
        restProjectMockMvc.perform(get("/api/projects/{id}", project.getId()))
            ...
            .andExpect(jsonPath("$.mydate").value(DEFAULT_MYDATE.toString()));
    }
    ...
    public void updateProject() throws Exception {
        ...
        project.setMydate(UPDATED_MYDATE);
        ...
        assertThat(testProject.getMydate()).isEqualTo(UPDATED_MYDATE);
    }
